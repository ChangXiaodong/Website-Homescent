...
function receive_op() {
	...
	if(reveive[0]!='登')
	{
		...
		window.location.href="./threemonth.php";
	} 
	return 1;
}
</script>
...
$starttime = date("H:i:s",$date + 3600 * 8-3600*24*30*3);//三个月
$startdate = date("Y-m-d",$date + 3600 * 8-3600*24*30*3);
$start_time = $startdate." ".$starttime;
$startdatevalue=$startdate;
$starttimevalue = date("H:i",$date + 3600 * 8-3600*24*30*3);
			...
			<article>
				<div class='tabs'>
					<ul class='horizontal'>
						...
						<li style="background: #a0cac0;border-bottom: 4px solid #68a697;"><a style="color: white;" href="threemonth.php" >三个月</a></li>
					</ul>
			</article>
		</section>	
	</div>
