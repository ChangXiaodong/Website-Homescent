...
function receive_op() {
	...
	document.getElementById('toggleLogin').innerHTML = receive;
		if(receive.length!=0&&receive[0]!="登"){
			// document.cookie="username="+receive+";path=/;";

			document.cookie="username="+receive+";path=/;";
			window.location.href="./onehour.php";
			return 1;
		}
	}
...
$starttime = date("H:i:s",$date + 3600 * 7);//一个小时
$startdate = date("Y-m-d",$date + 3600 * 7);
$start_time = $startdate." ".$starttime;
$startdatevalue=$startdate;
$starttimevalue = date("H:i",$date + 3600 * 7);
	...
	<div id="body_wrapper">
		...
		<section>
			<article>
				<div class='tabs'>
					<ul class='horizontal'>
						<li style="background: #a0cac0;border-bottom: 4px solid #68a697;"><a style="color: white;" href="onehour.php">一小时</a></li>
