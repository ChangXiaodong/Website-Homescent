...
function receive_op() {
	...
	if(reveive[0]!='登')
	{
		...
		window.location.href="./threehour.php";
	} 
	return 1;
}
</script>
...
$starttime = date("H:i:s",$date + 3600 * 5);//三个小时
$startdate = date("Y-m-d",$date + 3600 * 5);
$start_time = $startdate." ".$starttime;
$startdatevalue=$startdate;
$starttimevalue = date("H:i",$date + 3600 * 5);
			...
			<article>
				<div class='tabs'>
					<ul class='horizontal'>
						...
						<li style="background: #a0cac0;border-bottom: 4px solid #68a697;"><a style="color: white;" href="threehour.php" >三小时</a></li>
