...
function receive_op() {
	...
	if(reveive[0]!='登')
	{
		...
		document.getElementById('toggleLogin').innerHTML = reveive;
		window.location.href="./oneday.php?loginname="+name;
	} 
	return 1;
}
</script>
...
$starttime = date("H:i:s",$date + 3600 * 8-3600*24);//三个月
			...
			<article>
				<div class='tabs'>
					<ul class='horizontal'>
						...
						<li style="background: #a0cac0;border-bottom: 4px solid #68a697;"><a style="color: white;" href="oneday.php" >一天</a></li>
